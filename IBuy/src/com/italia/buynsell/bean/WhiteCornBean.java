...
public class WhiteCornBean {
	...
	if(isOk){
			...
			/*
			 * if(getCustomerName()!=null && !getCustomerName().isEmpty()){ str
 ...
 public String viewDeducted(String receiptNumber){
	...
	private void updateData(List data){
		...
		//String clientId = selectedClientName(getCustomerName());
	...
	public List<ClientProfile> autoClientSuggestion(String query){
		...
		return  ClientProfile.retrieveClientProfile(sql, params);
	}
