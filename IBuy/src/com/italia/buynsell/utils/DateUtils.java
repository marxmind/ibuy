...
public class DateUtils {
	 ...
	 * @format YYYY-MM-DD
	 */
	public static String getCurrentYYYYMMDD(){//YYYY-MM-DD
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");//new SimpleDateFormat("MM/dd/yyyy");//new SimpleDateFormat("yyyy/MM/dd hh:mm: a");
		Date date = new Date();
		return dateFormat.format(date);
	}
	/**
	...
	public static String getEndOfMonthDate(String dateFormat, Locale locale){
		...
		LocalDate now = LocalDate.parse(DateUtils.getCurrentYYYYMMDD(), dateTimeFormatter);
...
//		/int second = Integer.valueOf(date.substring(1, 2));
	...
	public String convertPM12FormatTime(String hour) {
